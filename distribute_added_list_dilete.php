...
if(!$_SESSION['user'])
{
	...
	$query2 = "DELETE FROM distribute WHERE p_id='$id' and quantity = '$nq' and point = '$pp' and date = '$today' ";
	...
	if ($q2>0) {
		...
		//point_inventory update
		$query4="UPDATE point_inventory SET quantity=quantity-'$nq'  WHERE point = '$pp' AND p_id = '$id' ";
		$b4=mysqli_query($conn,$query4);
